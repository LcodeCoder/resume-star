...
@media (max-width: 520px) { .gateway { padding: 14px 12px; }.gateway-brand small { display: none; }.gateway-story h1 { font-size: 38px; }.gateway-story > p { font-size: 14px; }.gateway-console { padding: 22px 16px; }.form-pair { grid-template-columns: 1fr; gap: 0; } }
</style>
