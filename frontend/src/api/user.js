...
export const getMe = () => request.get('/user/me', { skipAuthRedirect: true, silent: true, silentError: true })
...
export const getUserQuota = () => request.get('/user/quota', { skipAuthRedirect: true, silent: true, silentError: true })
